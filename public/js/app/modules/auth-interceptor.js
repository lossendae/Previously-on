/**
 * Auth Module for AngularJS
 * @version v0.1.0
 * @license MIT License, http://www.opensource.org/licenses/MIT
 */
(function (window, angular, undefined) {
    'use strict';
    var auth = angular.module('authInterceptor', ['httpAuthInterceptorBuffer']);

    auth.service('authInterceptor', ['$resource', '$rootScope', 'httpBuffer',
        function ($resource, $rootScope, httpBuffer) {
    ...
    auth.config(['$httpProvider', function ($httpProvider) {
        ...
        $httpProvider.interceptors.push(['$rootScope', '$q', 'httpBuffer', interceptor]);
    }]);

    /**
     * Private module, a utility, required internally by 'adminAuth'.
     */
